...
public class Venue
{
    ...
    private ArrayList<ItemSet> venueItemSets;
     ...
     */
    public ArrayList<ItemSet> getVenueItemSets()
    {
        ArrayList<ItemSet> deepCopy = new ArrayList<ItemSet>();
        for(ItemSet set : venueItemSets)
        {
     ...
     */
    public void addVenueItemSet(ItemSet set)
    {
        venueItemSets.add(new ItemSet(set));
    }
