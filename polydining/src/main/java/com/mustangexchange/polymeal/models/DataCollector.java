    ...
    private void handleInitConnection() throws NoSuchAlgorithmException, KeyManagementException {
        ...
        HttpsURLConnection.setDefaultHostnameVerifier(new HostnameVerifier() {
            public boolean verify(String hostname, SSLSession session) {
                return hostname.equals(PolyApplication.JSA_HOSTNAME) || hostname.equals(PolyApplication.CP_HOSTNAME);
            }
        });
        ...
        context.init(null, new X509TrustManager[]{new X509TrustManager() {
            ...
            {
                /* Failing public key. Will implement later.
                final String key = "";
                if (chain == null) {
                ...
                // Pin it!
                final boolean expected = key.equalsIgnoreCase(encoded);
                if (!expected) {
                    throw new CertificateException("checkServerTrusted: Expected public key: "
                            + key + ", got public key:" + encoded);
                }
                */
            }
