            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        switch (position) {
                            case 0:
                                Fragment inView = getSupportFragmentManager().findFragmentById(R.id.fragment_layout);
                                ...
                                break;
                            case 1:
                                Fragment inView2 = getSupportFragmentManager().findFragmentById(R.id.fragment_layout);
